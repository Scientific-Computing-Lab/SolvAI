...
Every figure is supplied as vector PDF/SVG plus a 360-dpi PNG inspection copy.
`ED_Table1.pdf` is compiled from `ED_Table1.tex` using
`ED_Table1_standalone.tex`.
