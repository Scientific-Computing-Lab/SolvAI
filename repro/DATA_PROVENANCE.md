...
All external supervised records were canonicalized before fitting and every
ARROW-85 connectivity was removed globally. The exact processed-file hashes are
also stored in `data/manifests/training_source_manifest.json`. Counts below are
records unless the role explicitly says structures or connectivities.
...
|---|---|---:|---:|---:|---|---|---|---|---:|---|
| MolSolv SMD(water) | water-specific quantum-continuum response | 1,729,545 records; 710 MB archive | 350,391 structures | 82 exact structures and 3 connectivity aliases | Zenodo 7262826 | [10.5281/zenodo.7262826](https://doi.org/10.5281/zenodo.7262826) | `758b9b56a991d874fb1067eca024dbc2244e67f8c8eb319db08ec4ab33e07460` | CC BY 4.0 data | yes | `python scripts/download_data.py molsolv` |
| ConfSolv H2O | conformer and solvent-response hierarchy | 5,392,567 H2O rows; 11.5 GB archive | 39,878 connectivities | 13 | Zenodo 8292520 | [10.5281/zenodo.8292520](https://doi.org/10.5281/zenodo.8292520) | `d283d2da04987a1802dbf60c5606394ac745c26609e2628144874b27bd037e27` | CC BY 4.0 | yes | `python scripts/download_data.py confsolv` |
...
| CombiSolv-QM water | COSMOtherm water response | 3,988 water records | 3,963 | 25 | publisher supplementary file | [10.1016/j.cej.2021.129307](https://doi.org/10.1016/j.cej.2021.129307) | `6fbaceff441b62c8399aae2dbd3b6cfbdfa10b86fc47cee8d60001c73da24832` | publisher supplementary terms; no standalone data licence | no | `python scripts/download_data.py combisolv-qm --accept-source-terms` |
